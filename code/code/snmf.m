...
% 
% Authors:
%   Mikkel N. Schmidt and Morten M�rup, 
%   Technical University of Denmark, 
%   Institute for Matematical Modelling
%
% References:
%   [1] M. M�rup and M. N. Schmidt. Sparse non-negative matrix factor 2-D 
%       deconvolution. Technical University of Denmark, 2006.
%   [2] M. N. Schmidt and M. M�rup. Nonnegative matrix factor 2-D 
%       deconvolution for blind single channel source separation. 
%       ICA, 2006.
%   [3] M. N. Schmidt and M. M�rup. Sparse non-negative matrix factor 2-d 
